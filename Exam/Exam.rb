...
3.Контакти. Створити ієрархію контактних даних (телефон, скайп, пошта, акаунт у соціальних мережах і т. д.).
Передбачити можливість об'єднання контактів.
Виконати пошук контактів по одному або декільком критеріям (збіг по частині імені, номера і т. д.).
 Організувати сортування контактів по імені або прізвищу.
=end
class BasicContact
  attr_accessor :name
